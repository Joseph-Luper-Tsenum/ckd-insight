...
def load_pipeline():
    ...
    return models, preprocessor, X_test, y_test, feature_names


models, preprocessor, X_test, y_test, feature_names = load_pipeline()
...
def predict_patient(patient_data, model_name):
...
# Run prediction
result = predict_patient(example_patient, "Random Forest")
